...
<div>
    ...
    <div id="structuremap">
        <span id="upload" class="el-icon-upload"></span>
        <span id="menu" class="el-icon-menu"></span>
    </div>
    <!--<canvas id="big" width="800" height="800">-->
    <div id="bg">
...
export default{
        mounted(){
            function Draw(){
                ...
                this.isDraw = false;
                this.structuremap = document.getElementById('structuremap');
            ...
            Draw.prototype.init = function(){
                ...
                this.structuremap.addEventListener('click',function(event){
